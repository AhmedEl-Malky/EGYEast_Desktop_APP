...
class FilmCard {
    ...
    public FilmCard(String title, String path) {
        this.title = title;
        this.path = path;
    ...
    public RoundedPanel createCardPanel() {
        ...
        cardPanel.add(image, BorderLayout.CENTER);
            ...
            public void mousePressed(MouseEvent e){
                String sql = "SELECT Content_id ,Title, Pic_path, Cover_path, Pic1_path, Pic2_path, Pic3_path, release_date, Category, Description, Trailer_link FROM Content WHERE Title = '" + title + "'"  ;
